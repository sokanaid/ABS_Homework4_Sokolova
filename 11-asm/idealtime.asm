...
;double IdealTimeTransport(void *s) {
;    int k = *((int*)s);
;    if(k == RECTANGLE) {
...
;                mov rdi, rax
            ...
            ;call OutShape             
            call IdealTimeTransport ;результат в xmm0
...
;            call printf
            ...
            ;mov r8, [rdi+4]   
            mov [.adress2], rdi
            call IdealTimeTransport ;результат в xmm0 IdealTime(*c.cont[(j - d)])
